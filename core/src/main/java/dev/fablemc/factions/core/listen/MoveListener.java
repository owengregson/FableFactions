 ...
 * ignoreCancelled=true} for both {@code PlayerMoveEvent} and {@code PlayerTeleportEvent}. The
 ...
 * <b>Mutability:</b> immutable (injected collaborators only). Floor-safe baseline listener — no
